...
export default function Home() {
  ...
  const numberOfWhitlistLeft = 20 - numberOfWhitelisted;
    ...
    <div>
      ...
      <div className={styles.main}>
         <div>
          ...
          <div className={styles.description}>
          <a href="https://mumbai.polygonscan.com/address/0xB56eC9d68E18d5D149A9C013f381B038a213180C#code"> The smart contract is verified ✅ <strong><u>Read it yourself</u></strong> 📖 </a>
          </div>
          <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="./ITU_1.jpg" />
        </div>
      </div>
